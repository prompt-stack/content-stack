...
describe('Badge', () => {
  ...
  const renderComponent = (props = {}) => {
    return render(<Badge {...defaultProps} {...props}>Badge Text</Badge>);
  };
  ...
  describe('state', () => {
    ...
    it('should update when props change', () => {
      const { rerender } = renderComponent({ variant: 'blue' });

      rerender(<Badge {...defaultProps} variant="green">Updated</Badge>);
  ...
  describe('performance', () => {
    it('should not re-render unnecessarily', () => {
      ...
      const TestComponent = () => {
        renderSpy();
        return <Badge {...defaultProps}>Test</Badge>;
      };
